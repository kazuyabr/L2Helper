...
;Запись последовательности пикселей в файл
;$i = 0
;$x = 677
;$y = 490
;Dim $enterButtonPixels[10]
;While $i < 10
;   $pixelColor = PixelGetColor($x, $y, $windowHandle)
;   $enterButtonPixels[$i] = $pixelColor
;   $x = $x + 1
;   $i = $i + 1
;WEnd
;_FileWriteFromArray("castle.txt", $enterButtonPixels)
